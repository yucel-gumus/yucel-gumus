<div id="header" align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=1,12,24&height=220&section=header&text=Yücel+Gümüş&fontSize=50&fontAlignY=38&desc=Full+Stack+Developer+|+AI+and+Spatial+Intelligence+Specialist&descFontSize=18&descAlignY=62&fontColor=ffffff" width="100%"/>
...
Merhaba! Ben **Yücel Gümüş**. Modern web teknolojileri, **Yapay Zeka (Agentic AI, RAG, MCP)** sistemleri ve **Coğrafi Bilgi Sistemleri (GIS)** alanlarında uçtan uca yüksek performanslı çözümler üreten bir **Full Stack Developer**'ım.

- 🌐 Kişisel projelerimi ve canlı demoları keşfetmek için resmi portfolyomu ziyaret edebilirsiniz: **[yucelgumus.dev](https://www.yucelgumus.dev/)**
- 🚀 **Next.js, React, TypeScript, Python (FastAPI), .NET Core** ve **Model Context Protocol (MCP)** teknolojileriyle üretim standartlarında projeler geliştiriyorum.
- 📍 Mekansal zeka, Leaflet, CesiumJS ve yapay zeka ajanlarını (Gemini 1.5 Pro / Flash) bir araya getiren yenilikçi mimariler tasarlıyorum.

---

## 🛠️ Yetenek & Teknoloji Yığını (Tech Stack)
...
![LangGraph](https://img.shields.io/badge/LangGraph-FF9900?style=flat-square)
![MCP](https://img.shields.io/badge/Model_Context_Protocol-purple?style=flat-square)
![Hugging Face](https://img.shields.io/badge/Hugging_Face-FFD21E?style=flat-square&logo=huggingface&logoColor=black)

### Harita & GIS (Geospatial)
![Leaflet](https://img.shields.io/badge/Leaflet-199900?style=flat-square&logo=leaflet&logoColor=white)
![CesiumJS](https://img.shields.io/badge/CesiumJS-00A3E0?style=flat-square&logo=cesium&logoColor=white)
![GeoJSON](https://img.shields.io/badge/GeoJSON-blue?style=flat-square)
![Proj4](https://img.shields.io/badge/Proj4-orange?style=flat-square)

### Veritabanı & Bulut (DevOps)
...
| :--- | :--- | :--- |
| 🚀 **[Portfolio Web Sitesi](https://www.yucelgumus.dev/)** | Modern, animasyonlu ve tam SEO uyumlu kişisel portfolyo | React 19, TypeScript, Tailwind |
| 🌐 **[RAG Web Chat](https://github.com/yucel-gumus/RAG_Web_Chat)** | Canlı web siteleri üzerinde SSRF korumalı RAG soru-cevap platformu | Next.js 15, LangChain, Gemini |
| 🌍 **[GeoGemini](https://github.com/yucel-gumus/GeoGemini)** | Gemini 1.5 çok modlu mekansal ve coğrafi zeka analiz aracı | React 18, Leaflet, Gemini AI |
| 📊 **[GA4 MCP Chat](https://github.com/yucel-gumus/GA4_MCP_Chat)** | Google Analytics 4 verilerini doğal dilde sorgulayan MCP asistanı | TypeScript, React, MCP, GA4 |
...
- 🌐 **Resmi Web Sitesi / Portfolyo:** [yucelgumus.dev](https://www.yucelgumus.dev/)
...
- 🤗 **Hugging Face:** [@yucelgumus61](https://huggingface.co/spaces/yucelgumus61)
